...
python -u train.py --experiment_name vision-aided-cifar-10_clip --DiffAugment translation,cutout \
...
cp -r $WEIGHTS_PATH/vision-aided-cifar-10_clip $WEIGHTS_PATH/vision-aided-cifar-10_clip_dino

python -u train.py --experiment_name vision-aided-cifar-10_clip_dino --DiffAugment translation,cutout \
--mirror_augment --use_multiepoch_sampler \
--which_best FID --num_inception_images 10000 \
--shuffle --batch_size 50 --parallel \
...
cp -r $WEIGHTS_PATH/vision-aided-cifar-10_clip_dino $WEIGHTS_PATH/vision-aided-cifar-10_clip_dino_swin

python -u train.py --experiment_name vision-aided-cifar-10_clip_dino_swin --DiffAugment translation,cutout \
--mirror_augment --use_multiepoch_sampler \
--which_best FID --num_inception_images 10000 \
--shuffle --batch_size 50 --parallel \
