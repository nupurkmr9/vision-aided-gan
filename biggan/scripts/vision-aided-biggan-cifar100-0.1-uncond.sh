...
python -u train.py --experiment_name vision-aided-cifar-100-0.1-uncond_clip --DiffAugment translation,cutout \
...
--num_D_steps 4 --G_lr 2e-4 --D_lr 2e-4  --num_samples 5000 --self_modulation \
--dataset C100 \
...
cp -r $WEIGHTS_PATH/vision-aided-cifar-100-0.1-uncond_clip $WEIGHTS_PATH/vision-aided-cifar-100-0.1-uncond_clip_dino

python -u train.py --experiment_name vision-aided-cifar-100-0.1-uncond_clip_dino --DiffAugment translation,cutout \
--mirror_augment --use_multiepoch_sampler \
--which_best FID --num_inception_images 10000 \
--shuffle --batch_size 50 --parallel \
...
cp -r $WEIGHTS_PATH/vision-aided-cifar-100-0.1-uncond_clip_dino $WEIGHTS_PATH/vision-aided-cifar-100-0.1-uncond_clip_dino_swin

python -u train.py --experiment_name vision-aided-cifar-100-0.1-uncond_clip_dino_swin --DiffAugment translation,cutout \
--mirror_augment --use_multiepoch_sampler \
--which_best FID --num_inception_images 10000 \
--shuffle --batch_size 50 --parallel \
